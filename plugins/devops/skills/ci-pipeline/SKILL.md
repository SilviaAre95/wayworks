...
2. **Generate pipeline config**:
   ...
   Templates to adapt: `references/templates.md` — a full GitHub Actions pipeline, plus the Railway and Vercel variants. Match the project's package manager, runtime version and deploy target rather than pasting one unread.
